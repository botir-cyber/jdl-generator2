...
ADD COLUMN IF NOT EXISTS ${field.name.snakeCase} ${field.type.pgName}<#if field.validation??><#assign valid = field.validation/><#if valid.required??> NOT NULL</#if><#if valid.unique??> UNIQUE</#if></#if>,
</#list>
