DROP FUNCTION IF EXISTS task.author_get_summary_list;
CREATE FUNCTION task.author_get_summary_list(
    in_login_id BIGINT,
...
AS $$
/******************************************************************************
**		File: task.author_get_summary_list.sql
**		Name: task.author_get_summary_list
...
DECLARE
    FN_NAME CONSTANT TEXT := 'task.author_get_summary_list';
    STEP_INDEX INTEGER;
