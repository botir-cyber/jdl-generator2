DROP FUNCTION IF EXISTS task.author_get_all;
CREATE FUNCTION task.author_get_all(
  in_login_id BIGINT
)
RETURNS TABLE (
  author_id BIGINT,
...
AS $$
/******************************************************************************
**		File: task.author_get_all.sql
**		Name: task.author_get_all
...
DECLARE
  FN_NAME CONSTANT TEXT := 'task.author_get_all';
  STEP_INDEX INTEGER;
